...
\begin{figure}
  ...
  \resizebox{1.0\textwidth}{!}{
    ...
    \begin{tabular}{cc}
      ...
      \href{https://nbviewer.org/github/vicente-gonzalez-ruiz/denoising/blob/main/notebooks/Confocal_FISH_noisy__GF.ipynb}{\includegraphics{Confocal_FISH_noisy}} & \href{https://nbviewer.org/github/vicente-gonzalez-ruiz/denoising/blob/main//notebooks/Confocal_FISH_noisy__GF.ipynb}{\includegraphics{TwoPhoton_MICE_noisy}} \\
      \href{https://nbviewer.org/github/vicente-gonzalez-ruiz/denoising/blob/main/notebooks/Confocal_FISH_noisy__GF.ipynb}{\includegraphics{Confocal_FISH_denoised__GD}} & \href{https://nbviewer.org/github/vicente-gonzalez-ruiz/denoising/blob/main/notebooks/Confocal_FISH_noisy__GF.ipynb}{\includegraphics{TwoPhoton_MICE_denoised__GD}}
    \end{tabular}
  }
