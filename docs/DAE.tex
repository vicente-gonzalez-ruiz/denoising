...
cryoCARE-REO(noisy_vol):
  ...
  model = train(even_vols=[even_vol_registered, even_vol],
    ...
    # The order of the volumes in the lists matters:
    # 1. even_vol_registered is a projection of even_vol to match odd_vol.
    # 2. odd_vol_registered is a projection of odd_vol to match even_vol.
  denoised_vol = predict(model, noisy_vol, noisy_vol)
  return denoised_vol
...
\begin{figure}
  \centering
  \href{https://github.com/vicente-gonzalez-ruiz/denoising/blob/main/docs/DAE/cryoCARE/corbel_big/denoise_even_odd.ipynb}{\includegraphics[width=1.0\textwidth]{~/gdrive_tomomgram_denoising/tmp/corbel_big__denoised__cryoCARE_even_odd.pdf}}
  \caption{Denoising of Corbel Big (see Fig.~\ref{fig:corbel_big}) using
    cryoCARE-EO.\label{fig:cryoCARE_corbel_big_denoise_even_odd}}
\end{figure}

\begin{figure}
  \centering
  \href{https://github.com/vicente-gonzalez-ruiz/denoising/blob/main/docs/DAE/cryoCARE/corbel_big/denoise_odd_and_even_registered.ipynb}{\includegraphics[width=1.0\textwidth]{~/gdrive_tomomgram_denoising/tmp/corbel_big__denoised__cryoCARE_even_odd_registered.pdf}}
  \caption{Denoising of Corbel Big using  (see Fig.~\ref{fig:corbel_big})
    cryoCARE-REO.\label{fig:cryoCARE_corbel_big_denoise_even_odd_registered}}
\end{figure}

\begin{figure}
  \centering
  \href{https://github.com/vicente-gonzalez-ruiz/denoising/blob/main/docs/DAE/cryoCARE/epfl1_subset1_float/denoise_even_odd.ipynb}{\includegraphics[width=1.0\textwidth]{~/gdrive_tomomgram_denoising/tmp/epfl1_subset1_float__denoised__cryoCARE_even_odd.pdf}}
...
\begin{figure}
  \centering
  \href{https://github.com/vicente-gonzalez-ruiz/denoising/blob/main/docs/DAE/cryoCARE/epfl1_subset1_float/denoise_odd_and_even_registered.ipynb}{\includegraphics[width=1.0\textwidth]{~/gdrive_tomomgram_denoising/tmp/epfl1_subset1_float__denoised__cryoCARE_even_odd_registered.pdf}}
