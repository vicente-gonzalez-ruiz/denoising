...
cryoCARE-REO(noisy_vol):
  ...
  model = train(even_vols=[even_vol_registered, even_vol], # The order in lists matters
...
\begin{figure}
  ...
  \caption{Denoising of EMPIAR-11415 (see Fig.~\ref{fig:corbel_big}) using
    cryoCARE-EO.\label{fig:cryoCARE_corbel_big_denoise_even_odd}}
\end{figure}

\begin{figure}
  \centering
  \href{https://github.com/vicente-gonzalez-ruiz/denoising/blob/main/docs/DAE/cryoCARE/corbel_big/denoise_odd_and_even_registered.ipynb}{\includegraphics[width=1.0\textwidth]{~/gdrive_tomomgram_denoising/tmp/corbel_big__denoised__cryoCARE_odd_even_registered.pdf}}
  \caption{Denoising of EMPIAR-11415 using  (see Fig.~\ref{fig:corbel_big})
