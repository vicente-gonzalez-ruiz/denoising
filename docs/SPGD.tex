...
\begin{figure}[h]
  ...
  \caption{Denoising of Corbel Small (see Fig.~\ref{fig:corbel_small}) using
    SPGD.\label{fig:SDPG_corbel_small}}
\end{figure}

\begin{figure}
  \centering
  \href{https://github.com/vicente-gonzalez-ruiz/denoising/blob/main/docs/SPGD/epfl1/denoise.ipynb}{\includegraphics[width=1.0\textwidth]{~/gdrive_tomomgram_denoising/tmp/epfl1_subset1_float.mrc__denoised__SPGD.pdf}}
