...
\begin{enumerate}
\item If $k$ is small, the attenuation of the stop-band increases (see
  \ref{fig:gaussian_leakage}). Therefore, $k$ should be big enought to
  avoid this problem.
...
\begin{figure}
  ...
  \caption{Impact of $k$ in the frequency response of a digital
    ...
    models the truncation in length of the
