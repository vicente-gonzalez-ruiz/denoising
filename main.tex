...
\item \textbf{Quantization noise}, that is usually modeled as additive
  ...
  \begin{figure}
    ...
    \resizebox{1.0\textwidth}{!}{
      ...
      \begin{tabular}{cc}
        \href{https://nbviewer.org/github/vicente-gonzalez-ruiz/denoising/blob/main/figs/averaging_denoising.ipynb\#Display-Barb}{\includegraphics{barb}} & \href{https://nbviewer.org/github/vicente-gonzalez-ruiz/denoising/blob/main/figs/averaging_denoising.ipynb\#0MAUN-Barb}{\includegraphics{0MAUN_barb}} \\
...
\item \textbf{Speckle noise}, which can be considered multiplicative
  ...
  \begin{figure}
    ...
    \resizebox{1.0\textwidth}{!}{
      ...
      \setlength{\tabcolsep}{0ex}      % Adjust column spacing in the table    
      \begin{tabular}{cc}
        \includegraphics{barb} & \includegraphics{0MMGN_barb} \\
 ...
 Fig.~\ref{fig:Poisson} shows an example of
  ...
  \begin{figure}
    ...
    \resizebox{1.0\textwidth}{!}{
      ...
      \setlength{\tabcolsep}{0ex}      % Adjust column spacing in the table    
      \begin{tabular}{cc}
        \includegraphics{barb} & \includegraphics{Poisson_barb} \\
