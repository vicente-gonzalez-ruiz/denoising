...
\begin{figure}[h]
  ...
  \caption{WideField BPAE (clean, red channel)\cite{zhang2019poisson}.\label{fig:WideField_BPAE_R}}
\end{figure}
...
\begin{figure}[h]
  ...
  \caption{WideField BPAE (clean, green channel)\cite{zhang2019poisson}.\label{fig:WideField_BPAE_G}}
\end{figure}
...
\begin{figure}[h]
  ...
  \caption{WideField BPAE (clean, blue channel)\cite{zhang2019poisson}.\label{fig:WideField_BPAE_B}}
\end{figure}
\end{comment}
