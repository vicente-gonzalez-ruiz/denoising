...
\begin{figure}[h]
  ...
  \caption{Confocal FISH noisy \cite{zhang2019poisson}.\label{fig:Confocal_FISH_noisy}}
\end{figure}
...
\begin{figure}[h]
  ...
  \caption{Two-photons MICE noisy \cite{zhang2019poisson}.\label{fig:TwoPhoton_MICE_noisy}}
\end{figure}
...
\begin{figure}[h]
  ...
  \caption{Confocal MICE noisy \cite{zhang2019poisson}.\label{fig:Confocal_MICE_noisy}}
\end{figure}
