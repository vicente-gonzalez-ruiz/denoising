...
LPIPS \cit{zhang2018unreasonable} is a deep learning-based metric that
...
spectral profile) can provide valuable insights for determining the
optimal operational parameters of denoising algorithms. However, this
approach typically necessitates the availability of at least two
