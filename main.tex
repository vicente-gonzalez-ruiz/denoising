...
Noise measurement (power, statistical model, spectrum shape, etc.) can
be interesting to found the working parameters of a denoising
algorithms. Unfortunately, we require at least two noisy instances of
the clean signal to characterize the noise, circunstance that not
always can be achieved because the samples are sensitive to the
microscopy radiation.
